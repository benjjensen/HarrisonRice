...
for SNR = 1:100
    counts(1, SNR) = countGoodCarriers(harSignal, aveNoiseHar, SNR);
    counts(2, SNR) = countGoodCarriers(smaSignal, aveNoiseSma, SNR);
    counts(3, SNR) = countGoodCarriers(camSignal, aveNoiseCam, SNR);
end
