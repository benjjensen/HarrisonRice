...
hold on
text(114, 172, '*', 'Color', 'red', 'FontSize', 16);
text(110, 178, 'tx', 'Color', 'red', 'FontSize', 8);
...
q.YLabel.String = 'Capacity (bits/channel use)';
q.YLabel.FontSize = 8;
q.FontSize = 8;
marge = q.Position;
q.Position = [0.875 marge(2) 0.25*marge(3) marge(4)];

ff = gcf;
homer = ff.Units;
ff.Units = 'inches';
bart = ff.Position;
ff.Position = [bart(1:2) 6.5 3/4*6.5];
