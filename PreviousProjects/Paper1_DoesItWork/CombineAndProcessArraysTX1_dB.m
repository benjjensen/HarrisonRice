...
% understandable data from what was originally gathered. These data can be
% graphed in order to better understand the strengths of the signals
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for temp = 1:29
    for loops = 1:33
        ...
        tx1dB(:,36+temp,64+loops) = eval(obj);
    end
end
...
for temp = 1:31
    for loops = 1:26
        ...
        tx1dB(:,34+temp,122+loops) = eval(obj);
    end
end
...
for temp = 1:32
    for loops = 1:26
        ...
        tx1dB(:,33+temp,153+loops) = eval(obj);
    end
end
...
for temp = 1:32
    for loops = 1:28
        ...
        tx1dB(:,33+temp,212+loops) = eval(obj);
    end
end
% Insert Hallway
for temp = 1:23
    for loops = 1:300
        ...
        tx1dB(:,68+temp,42+loops) = eval(obj);
    end
end

save tx1dB.mat tx1dB;