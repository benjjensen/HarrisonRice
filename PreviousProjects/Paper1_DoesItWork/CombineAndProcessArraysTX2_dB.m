...
for temp = 1:30
    for loops = 1:34
        ...
        tx2dB(:,35+temp,64+loops) = eval(obj);
    end
end
...
for temp = 1:32
    for loops = 1:26
        ...
        tx2dB(:,33+temp,122+loops) = eval(obj);
    end
end
...
for temp = 1:32
    for loops = 1:26
        ...
        tx2dB(:,33+temp,153+loops) = eval(obj);
    end
end
...
for temp = 1:32
    for loops = 1:28
        ...
        tx2dB(:,33+temp,212+loops) = eval(obj);
    end
end
% Insert Hallway
for temp = 1:23
    for loops = 1:300
        ...
        tx2dB(:,68+temp,42+loops) = eval(obj);
    end
end

save tx2dB.mat tx2dB;